...
void GrammarDatabase::LoadConfiguration()
{
    ...
    _elementMap[configMgr->GetKeyCode("Element", "Hostile", Keys::Numpad3)] = Element::Hostile;
    _elementMap[configMgr->GetKeyCode("Element", "Friendly", Keys::Numpad1)] = Element::Friendly;
}
